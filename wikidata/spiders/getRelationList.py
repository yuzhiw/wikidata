...
import time
import re
from wikidata.items import WikidataItem
    ...
    def parse(self,response):
        ...
        for table in response.xpath('//table[contains(@class,"wikitable")]'):
            ...
            for li in table.xpath('.//li/a'):
                ...
                if ((rtype_list[rcount]=='Organization' and rsubtype=='Generic') or (rtype_list[rcount]=='Works' and
                rsubtype=='Film')):
                    continue
                tmp=WikidataItem()
                relationItem_list.append(WikidataItem())
